...
***************************************************************************** */
    ...
    da.init();
    const products_namespaceObject = JSON.parse('{"products":[{"id":5,"url":"#","title":"Grifo","text":"Night Lamp","labels":"","image":"05.jpg","price":"1.500.000","priceOld":"","shareUrl":"","likeUrl":""},{"id":6,"url":"#","title":"Muggo","text":"Small mug","labels":[{"type":"new","value":"New"}],"image":"06.jpg","price":"150.000","priceOld":"","shareUrl":"","likeUrl":""},{"id":7,"url":"#","title":"Pingky","text":"Cute bed set","labels":[{"type":"sale","value":"-50%"}],"image":"07.jpg","price":"7.000.000","priceOld":"","shareUrl":"","likeUrl":""},{"id":8,"url":"#","title":"Potty","text":"Minimalist flower pot","labels":[{"type":"new","value":"New"}],"image":"08.jpg","price":"500.000","priceOld":"","shareUrl":"","likeUrl":""}]}');
    const {products} = products_namespaceObject;
    window.onload = function() {
        ...
        function documentActions(e) {
            ...
            if (window.innerWidth > 768 && isMobile.any()) {
                ...
                const itemHover = document.querySelectorAll(".menu__item._hover");
                if (!targetElement.closest(".menu__item") && itemHover.length > 0) for (var i = 0; i < itemHover.length; i++) itemHover[i].classList.remove("_hover");
            }
            if (targetElement.classList.contains("search-header__button")) targetElement.closest(".search-header").classList.toggle("_active");
            const searchActiveButton = document.querySelector(".search-header._active");
            if (!targetElement.closest(".search-header") && searchActiveButton) searchActiveButton.classList.remove("_active");
            if (targetElement.classList.contains("footer-products__button")) {
            ...
            if (targetElement.classList.contains("cart-header__icon") || targetElement.closest("actions-header__icon")) {
            ...
            async function getProducts(button) {
                if (!button.classList.contains("_hold")) {
                    ...
                    let response = await fetch("https://my-json-server.typicode.com/AlberUA/Test/db", {
                        method: "GET"
                    });
                    if (response.ok) {
            ...
            function loadProducts(data) {
                ...
                data.products.forEach((item => {
                    ...
                    const productsPtice = item.price;
                    const productsOldPrice = item.priceOld;
                    const productsShareUrl = item.shareUrl;
                    const productsLikeUrl = item.likeUrl;
                    const productsLabels = item.labels;
                    let productTemplateStart = `<article data-pid="${productsId}" class="products__item item-product">`;
                    ...
                    if (productsLabels) {
                        ...
                        productsLabels.forEach((labelItem => {
                    ...
                    let productTemplateImage = `\n                              <a href="${productsUrl}" class="item-product__image -ibg">\n                                 <img src="img/products/${productsImage}" alt="${productsTitle}">\n                              </a>\n            `;
                    ...
                    let productTemplatePricesCurrent = `<div class="item-product__price">Rp ${productsPtice}</div>`;
                    let productTemplatePricesOld = `<div class="item-product__price item-product__price_old">Rp ${productsOldPrice}</div>`;
                    let productTemplatePricesEnd = `</div>`;
                    productTemplatePrices = productTemplatePricesStart;
                    productTemplatePrices += productTemplatePricesCurrent;
                    if (productsOldPrice) productTemplatePrices += productTemplatePricesOld;
                    productTemplatePrices += productTemplatePricesEnd;
                    let productTemplateActions = `\n                                 <div class="item-product__actions actions-product">\n                                    <div class="actions-product__body">\n                                       <a href="#" class="actions-product__button btn">Add to cart</a>\n                                       <a href="${productsShareUrl}" class="actions-product__link _icon-share">Share</a>\n                                       <a href="${productsLikeUrl}" class="actions-product__link _icon-favorite">Like</a>\n                                    </div>\n                                 </div>\n            `;
                    ...
                    let productTempate = "";
                    productTempate += productTemplateStart;
                    productTempate += productTemplateLabels;
                    productTempate += productTemplateImage;
                    productTempate += productTemplateBody;
                    productTempate += productTemplateEnd;
                    productsItems.insertAdjacentHTML("beforeend", productTempate);
                }));
            }
            ...
            if (furniture && !isMobile.any()) {
                const furnitureColumns = document.querySelector(".furniture__columns");
                ...
                function setMouseGalleryStyle() {
                    ...
                    furnitureColumn.forEach((elem => {
                        furnitureItemsWidth += elem.offsetWidth;
                    }));
                    const furnitureDifferentWidth = furnitureItemsWidth - furniture.offsetWidth;
                    const distX = Math.floor(coordXProcent - positionX);
                    positionX += distX * speed;
                    let position = furnitureDifferentWidth / 200 * positionX;
                    furnitureColumns.style.cssText = `transform: translate3d(${-position}px,0,0);`;
